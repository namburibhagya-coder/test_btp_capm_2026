...
context master {
    ...
    entity businesspartner {
        key NODE_KEY      : common.guid @title: '{i18n>PARTNER_KEY}';
            ...
            //column name at runtime ADDRESS_GUID_NODE_KEY
            ADDRESS_GUID  : Association to one address;
    };

    // Check table who is primary key is NODE_KEY
    entity address {
        key NODE_KEY        : common.guid;
            ...
            LATITUDE        : Decimal;
            LONGITUDE       : Decimal;
            //$self which represents the primary key of the current table.
            businesspartner : Association to one businesspartner
                                  on businesspartner.ADDRESS_GUID = $self
    };

    // create employee table .
    // cuid is a aspect provided by SAP out-of-box
